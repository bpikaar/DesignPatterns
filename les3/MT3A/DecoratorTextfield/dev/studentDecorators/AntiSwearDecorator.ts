class AntiSwearDectorater extends TxtDecorator {
    

    public getText(): string {
        //remove swear words from input
        return this.removeSwearWords(this.decoratedTxt.getText());
    }

    /**
     * Remove all swearwords from the input
     */
    private removeSwearWords(s : string) : string{
        //list of swearwords
    ...
    /*
    * Append bobba because someone was naughty
    */
    private createBobba(){
